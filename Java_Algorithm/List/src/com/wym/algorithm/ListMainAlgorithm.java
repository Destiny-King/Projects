...
import com.wym.algorithm.detectCycle.DetectCycle;
...
//		System.out.println(node.val);
		...
		int n = 8;
		ListNode listNode2 = new ListNode();
		ListNode cycle = listNode2.createCycle(n);
		listNode2.showCycle(cycle);
		ListNode node = detectCycle.detectCycle(cycle);
		System.out.println(node.val);
	}
}
